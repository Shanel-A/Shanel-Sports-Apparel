 var cities = {
	...
	'Bulacan' : [
		...
		'Calumpit','Dona Remedios Trinidad','Guiguinto','Hagonoy','Malolos','Marilao',
	...
	'Cagayan' : [
		...
		'Penablanca','Piat','Rizal','Sanchez-Mira','Santa Ana','Santa Praxedes',
		'Santa Teresita','Santo Nino','Solana','Tuao','Tuguegarao City'
		],	
	'Camarines Norte' : [
	...
	'Camarines Sur' : [
		...
		'Sagnay','San Fernando','San Jose','Sipocot','Siruma','Tigaon',
		'Tinambac'
		],
	'Camiguin' : [
	...
	'Iloilo' : [
		...
		'Carles','Concepcion','Dingle','Duenas','Dumangas','Estancia',
	...
	'Laguna' : [
		'Alaminos','Bay','Binan','Cabuyao','Calamba','Calauan',
	...
	'Nueva Ecija' : [
		...
		'Laur','Licab','Llanera','Lupao','Munoz','Nampicuan',
		'Palayan','Pantabangan','Penaranda','Quezon','Rizal','San Antonio',
		'San Isidro','Cabaritan','San Leonardo','Santa Rosa','Santo Domingo','Talavera',
		'Talugtug','Zaragoza'
		],
	'Nueva Vizcaya' : [
		'Alfonso Castaneda','Ambaguio','Aritao','Bagabag','Bambang','Bayombong',
	...
	'Palawan' : [
		...
		'Quezon','Rizal','Roxas','San Vicente','Sofronio Espanola','Taytay'
		],	
	'Pampanga' : [
	...
	'Samar' : [
		...
		'Santa Margarita','Santa Rita','Santo Nino','Tagapul-an','Talalora','Tarangnan',
		'Villareal','Zumarraga'
		],
	'Sarangani' : [
	...
	'South Cotabato' : [
		...
		'Santo Nino','Surallah','T\'Boli','Tampakan','Tantangan','Tupi'
		],
	'Southern Leyte' : [
	...
	'Zamboanga del Norte' : [
		...
		'Manukan','Mutia','Pinan','Polanco','President Manuel A. Roxas','Rizal',		
		'Salug','Sergio Osmena Sr.','Siayan','Sibuco','Sibutad','Sindangan',
